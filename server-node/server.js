...
let portData = [];
const ENV_HISTORY_FILE = path.join(__dirname, '../data/cache', 'environmental_history.json');
...
function initializeServer() {
    ...
    const landCachePath = path.join(__dirname, '../data/cache/grid-cache.json');
    ...
    const portFilePath = path.join(__dirname, '../data/cache/ports.csv');
